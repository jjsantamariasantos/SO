...
void ejecutarEntrada(char *entrada, char *argumentos[], historial *historial1, informacionFichero *ficherosAbiertos, informacionMemoria *listaMemoria)
{
    ...
    else
    {
        ...
        free(temp);
        temp = NULL;
        ejecutarOrden(entrada, argumentos, historial1, ficherosAbiertos, listaMemoria);
    }
}

void ejecutarOrden(char *entrada, char *argumentos[], historial *historial1,
                   informacionFichero *ficherosAbiertos, informacionMemoria *listaMemoria)
{
    ...
    case 6:
        ...
        {
            cmdCommand(argumentos[1], historial1, ficherosAbiertos, listaMemoria);
        }
        break;
    case 7:
        if (numeroArgumentos > 1 && strcmp(argumentos[1], "-?") == 0)
